...
## calculate the value of the standard instrumnet: nation-level immigrant-to-citizen ratio
...
library(dplyr)
library(tidyr)
income_data <- read_excel("Desktop/income_data.xlsx")
...
library(readxl)
voting_data <- read_excel("Desktop/voting_data.xlsx")
View(voting_data)
## unify the information of the state list and the state names
library(dplyr)
...
## lag some independent variables before merging all the dataset
...
## merge the relevant data frames, construct the panel data for regression, change some variable names, and delete observations with mising data
